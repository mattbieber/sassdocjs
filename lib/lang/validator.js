/**
 * Language definition validation module
 * @module lib/lang/validator
 */
//
//var dictionary = require('jsdoc/tag/lang');
//var format = require('env').format;
//
...
//		require('jsdoc/env/error').handle( new UnknownTagError(tag.title, meta) );
//	}
//
//	if (!tag.text) {
//		if (tagDef.mustHaveValue) {
//			require('jsdoc/env/error').handle( new TagValueRequiredError(tag.title, meta) );
//		}
//	}
//	else {
//		if (tagDef.mustNotHaveValue) {
//			require('jsdoc/env/error').handle( new TagValueNotPermittedError(tag.title, meta) );
//		}
//	}
//};
/**
